...
def build_docx_from_markdown():
    ...
    md_path = os.path.join(base_dir, "docs", "vibe-coding-process.md")
    docx_path1 = os.path.join(base_dir, "docs", "vibe-coding-process.docx")
    docx_path2 = os.path.join(base_dir, "VIBE_CODING_PROCESS.docx")
